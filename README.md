...
공부를 하고자 하는 의지는 있지만 다른 유혹에 의해 시작하는 것부터 어려움을 겪은 적이 많을 것이다. Make you study는 새 학기가 시작되어서 공부를 하고 싶다는 학생들에게 큰 도움을 줄 수 있는 훌륭한 앱이다. 계획을 적을 수 있는 캘린더, 하루의 일과를 적을 수 있는 다이어리, 시간 계획을 작성할 수 있는 타임테이블, 명언을 통한 사기진작, 사진을 통한 출석체크, 총 5가지의 기능을 갖고 있다. 출석체크의 기능은 본인이 타임테이블에 맞춰 놓은 시간을 통해 알람이 울리게 되면 바로 의자에 앉아서 책상사진을 찍어야만 오늘의 출석이 인정이 된다. 출석체크의 방식은 사물인식, Image Matching, Text 인식이 있다. 이러한 출석으로 일주일간의 공부 참여율 쉽게 확인할 수 있고 공부에 관한 흥미를 느낄 수 있을 것이다.
